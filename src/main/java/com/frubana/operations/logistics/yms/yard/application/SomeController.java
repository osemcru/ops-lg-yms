...
import com.frubana.operations.logistics.yms.yard.service.SomeService;
...
public class SomeController {
     ...
     *
     * @param yard the some object to be persisted in the repository, cannot be
     *             null.
